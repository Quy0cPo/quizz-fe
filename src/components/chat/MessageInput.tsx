  ...
  return (
    <form className="flex items-center gap-2 w-full relative" onSubmit={handleSubmit}>
      <input
        ref={inputRef}
        type="text"
        className="flex-1 h-10 bg-slate-50 border border-slate-200 rounded-xl px-3 pr-11 text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all"
